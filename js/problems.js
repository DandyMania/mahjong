const PROBLEMS = [
  // ===== BEGINNER =====
  {
    ...
    hand: [
      ...
      { tile: '4p',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '7s',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '3z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  },
  {
    ...
    hand: [
      ...
      { tile: '1m',  safe: true,  reason: '端牌（1m: 両面待ちに引っかかりにくい）' },
      { tile: '4p',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '4z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  },
  {
    ...
    hand: [
      ...
      { tile: '8m',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '7s',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '6z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  },
  {
    ...
    hand: [
      ...
      { tile: '3m',  safe: true,  reason: '今回の待ちに含まれない（単騎なので1種類のみ危険）' },
      { tile: '5p',  safe: true,  reason: '今回の待ちに含まれない（単騎なので1種類のみ危険）' },
      { tile: '4s',  safe: true,  reason: '今回の待ちに含まれない（単騎なので1種類のみ危険）' },
      { tile: '6z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  },
  {
    ...
    hand: [
      ...
      { tile: '9m',  safe: true,  reason: '端牌（9m: 両面待ちに引っかかりにくい）' },
      { tile: '1p',  safe: true,  reason: '端牌（1p: 両面待ちに引っかかりにくい）' },
      { tile: '1z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  // ===== MEDIUM =====
  {
    ...
    hand: [
      ...
      { tile: '2s',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '4z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
      { tile: '5z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  },
  {
    ...
    hand: [
      ...
      { tile: '7m',  safe: true,  reason: '今回の待ちに含まれない（単騎なので1種類のみ危険）' },
      { tile: '1s',  safe: true,  reason: '端牌（1s: 両面待ちに引っかかりにくい）' },
      { tile: '4s',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '3p',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '3z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
      { tile: '5z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  // ===== ADVANCED =====
  {
    ...
    hand: [
      ...
      { tile: '3m',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '6s',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '5z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
      { tile: '2z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  },
  {
    ...
    hand: [
      ...
      { tile: '4m',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '8p',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '1s',  safe: true,  reason: '端牌（1s: 両面待ちに引っかかりにくい）' },
      { tile: '2z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
      { tile: '5z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  },
  {
    ...
    hand: [
      ...
      { tile: '1m',  safe: true,  reason: '端牌（1m: 両面待ちに引っかかりにくい）' },
      { tile: '3s',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '2z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
      { tile: '5z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
      { tile: '6z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  },
  {
    ...
    hand: [
      ...
      { tile: '4m',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '2p',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '3s',  safe: true,  reason: '今回の待ちに含まれない' },
      { tile: '2z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
      { tile: '5z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
  ...
  },
  {
    ...
    hand: [
      ...
      { tile: '1m',  safe: true,  reason: '端牌（1m: 両面待ちに引っかかりにくい）' },
      { tile: '9s',  safe: true,  reason: '端牌（9s: 両面待ちに引っかかりにくい）' },
      { tile: '5z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
      { tile: '6z',  safe: true,  reason: '字牌（当たり牌になりにくい）' },
    ],
